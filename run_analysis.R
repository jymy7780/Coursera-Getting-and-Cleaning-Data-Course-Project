...
# Ensure that UCI HAR Dataset is downloaded, extracted into Working Directory
...
selected_var <- variable_names[
        grep("mean\\(\\)|std\\(\\)",variable_names[,2]),]
...
write.table(total_mean, file = "./UCI HAR Dataset/tidy_data.txt",
